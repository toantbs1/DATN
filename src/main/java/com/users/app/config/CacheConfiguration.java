...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.users.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.users.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.users.app.domain.User.class.getName());
