          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('altitude')}>
                  Altitude <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {taskList.map((task, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{task.startTime ? <TextFormat type="date" value={task.startTime} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{task.latitude}</td>
